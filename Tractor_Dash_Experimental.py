...
def listen_for_j1939():
    global can0, rpm, rpm_photo, rpm_avg, throttle_percent, load_percent, coolant_temp, oil_pressure, battery_voltage, oil_lamp_indicator, malfunction_lamp
    while True:
...
#     message = can.Message(arbitration_id=0x123, data=[0x01, 0x02, 0x03], is_extended_id=True)
#     bus.send(message)
#     time.sleep(1)
